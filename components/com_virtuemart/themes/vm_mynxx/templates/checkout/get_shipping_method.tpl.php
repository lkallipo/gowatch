...
echo '<div class="shipto-addresses-block"><div class="shipto-addresses-block-inner">';
$varname = 'PHPSHOP_CHECKOUT_MSG_' . CHECK_OUT_GET_SHIPPING_METHOD;
echo '<h4 class="shipping-method">'. $VM_LANG->_($varname) . '</h4>';

?>
<?php ps_checkout::list_shipping_methods($ship_to_info_id, $shipping_rate_id ); ?>
</div></div>