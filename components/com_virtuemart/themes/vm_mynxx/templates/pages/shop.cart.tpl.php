...
if ($cart["idx"]) {
	...
	<!-- cleverweb added back button -->
	<div ><a href='javascript:history.go(-1)' class="back_button">&nbsp; <?php //echo $VM_LANG->_('BACK') ?></a></div>
    <?php
    if( $continue_link != '') {
		?>
   ...
   if (!defined('_MIN_POV_REACHED')) { ?>
       ...
       <?php
   		...
   		$text = '';//cleverweb: remove text from image  $VM_LANG->_('PHPSHOP_CHECKOUT_TITLE');
