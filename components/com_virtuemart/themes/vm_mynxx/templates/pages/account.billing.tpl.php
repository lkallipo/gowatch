...
?>
<div class="update-shipping-page">
<div class="pathway"><?php echo $vmPathway; ?></div>
<div class="account-buttons"> 
   	<a href="#" onclick="if( submitregistration() ) { document.adminForm.submit(); return false;}">
   		<img border="0" src="images/blank.png" class="account-save" name="submit" alt="<?php echo $VM_LANG->_('CMN_SAVE') ?>" />
   	</a>
   	<a href="<?php $sess->purl( SECUREURL."index.php?page=$next_page") ?>">
   		<img src="images/blank.png" class="account-back" alt="<?php echo $VM_LANG->_('BACK') ?>" border="0" />
   	</a>
</div>
