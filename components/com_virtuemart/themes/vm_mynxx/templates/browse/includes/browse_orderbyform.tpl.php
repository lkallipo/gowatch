...
if( !empty( $product_type_id )) {
    ...
    echo '<input type="hidden" name="product_type_id" value="'.$product_type_id.'" />'; // cleverweb added for cherry picker
	echo $ps_product_type->get_parameter_form($product_type_id);
}

//cleverweb: and this is for prices
...
echo '<input type="hidden" name="low-price" value="'.$chp_low_price.'">';
echo '<input type="hidden" name="high-price" value="'.$chp_high_price.'">';
}
