...
//cleverweb: cherry picker mod to search in prices

global $mosConfig_absolute_path;
require_once($mosConfig_absolute_path.'/modules/mod_vm_cherry_picker/chp.class.php');
$chp=new chp();
...
$where_clause[]="`product_price`>=".$chp_low_price;
}
elseif(!$chp_low_price && $chp_high_price){
$where_clause[]="`product_price`<=".$chp_high_price;
}
elseif($chp_low_price && $chp_high_price && ($chp_high_price>$chp_low_price)){
$where_clause[]="`product_price` BETWEEN ".$chp_low_price." AND ".$chp_high_price;
}
