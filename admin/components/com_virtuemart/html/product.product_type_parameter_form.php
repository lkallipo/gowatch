...
?> 
  ...
  <table class="adminform">
    ...
    <!-- Start Product Filter mod -->
    <tr>
    	<td>
    		<div align="right" style="font-weight: bold;"><?php echo 'Include in filter:';?></div>
    	</td>
    	<td>
    		<input type="checkbox" name="parameter_include" value="Y" <?php if ($db->sf("parameter_include") != "N") echo "checked" ?> />
    	</td>
    </tr>
    <!-- End Product Filter mod -->
    <tr> 
