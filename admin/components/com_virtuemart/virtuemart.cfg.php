...
define( 'URL', 'http://localhost:8082/gowatch.gr/' );
define( 'SECUREURL', 'http://localhost:8082/gowatch.gr/' );

if ( (!empty($_SERVER['HTTPS']) && $_SERVER['HTTPS'] != 'off') || $_SERVER['SERVER_PORT'] == '443' ) {
	define( 'IMAGEURL', SECUREURL .'components/com_virtuemart/shop_image/' );
	define( 'VM_THEMEURL', SECUREURL.'components/com_virtuemart/themes/vm_mynxx/' );
} else {
	define( 'IMAGEURL', URL .'components/com_virtuemart/shop_image/' );
	define( 'VM_THEMEURL', URL.'components/com_virtuemart/themes/vm_mynxx/' );
}
define( 'VM_THEMEPATH', $mosConfig_absolute_path.'/components/com_virtuemart/themes/vm_mynxx/' );
...
define('DOWNLOADROOT', 'H:\wamp\www\Mynxx/');
...
define('ENCODE_KEY', 'ca4866e42477ea75fe6b0b7d6f9fdfa5');
define('NO_SHIPPING', '');
define('NO_SHIPTO', '');
